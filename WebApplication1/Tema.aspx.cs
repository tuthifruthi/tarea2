...
namespace WebApplication1
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Tema WHERE id_categoria='" + Request.QueryString["IDCat"] + "' AND publico='1'", cnn);
                ...
                SqlDataAdapter da1 = new SqlDataAdapter("SELECT nombre FROM Usuario WHERE id_usuario IN (SELECT id_usuario FROM Tema WHERE id_categoria='" + Request.QueryString["IDCat"] + "' AND publico='1')", cnn);
                ...
                SqlDataAdapter da3 = new SqlDataAdapter("SELECT * FROM Tema WHERE id_categoria='" + Request.QueryString["IDCat"] + "' AND publico='1'", cnn);
