...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Especifique su nombre de usuario y contraseña.</p>
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:TextBox ID="UserName" runat="server" CssClass="textEntry" Width="153px"></asp:TextBox>
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Iniciar sesión" OnClick="Submit_Click" />
                </p>
            </div>
        </LayoutTemplate>
</asp:Content>
