...
namespace WebApplication1
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strSQL = "DELETE FROM Tema WHERE id_categoria='" + Request.QueryString["IDCat"] + "'";
            SqlCommand myCommand = new SqlCommand(strSQL, con1);
            SqlDataReader d1 = myCommand.ExecuteReader();
            d1.Close();

            string strSQL2 = "DELETE FROM Categoria WHERE id_categoria='" + Request.QueryString["IDCat"] + "'";
